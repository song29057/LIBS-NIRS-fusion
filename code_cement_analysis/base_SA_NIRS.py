...
best_model_path = r'D:\Postdoc\Paper 12\Datasets\Cement\Models\SA_NIRS_model.pth'
train_losses = []
val_losses = []
best_epoch = 0
...
csv_path = r'D:\Postdoc\Paper 12\Datasets\Cement\Models\training_log_SA_NIRS.csv'
