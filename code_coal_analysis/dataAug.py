...
XTrain_LIBS = np.loadtxt(r'D:\Postdoc\Paper 12\Datasets\Coal Shandong/XTrain_LIBS.csv', delimiter=',')
XTrain_NIRS = np.loadtxt(r'D:\Postdoc\Paper 12\Datasets\Coal Shandong/XTrain_NIRS.csv', delimiter=',')
...
YTrain = np.loadtxt(r'D:\Postdoc\Paper 12\Datasets\Coal Shandong/YTrain.csv', delimiter=',')
...
# 定义保存数据的路径
save_path = r'D:\Postdoc\Paper 12\Datasets\Coal Shandong'
