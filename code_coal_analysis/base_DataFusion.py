...
class FeatureExtractor(nn.Module):
    def __init__(self):
        ...
        # Input dimension is 215 (NIR) + 244 (LIBS) = 459
        self.ln1 = nn.LayerNorm(459)
        self.fc1 = nn.Linear(459, 128)  # Increased dimension to capture combined features
        self.rl1 = nn.ReLU()
...
best_model_path = r'D:\Postdoc\Paper 12\Datasets\Coal Shandong\Models\DataFusion_model.pth'
train_losses = []
val_losses = []
best_epoch = 0
...
csv_path = r'D:\Postdoc\Paper 12\Datasets\Coal Shandong\Models\training_log_DataFusion.csv'
...
file_path = r"D:\Postdoc\Paper 12\Datasets\Coal Shandong\Prediction\Fusion\DataFusion_val.csv"
...
file_path = r"D:\Postdoc\Paper 12\Datasets\Coal Shandong\Prediction\Fusion\DataFusion_test.csv"
