...
XTrain_LIBS = np.loadtxt(r'D:\Postdoc\Paper 12\Datasets\Coal Shandong/XTrain_NIRS_aug.csv', delimiter=',')
XValid_LIBS = np.loadtxt(r'D:\Postdoc\Paper 12\Datasets\Coal Shandong/XValid_NIRS.csv', delimiter=',')
XTest_LIBS = np.loadtxt(r'D:\Postdoc\Paper 12\Datasets\Coal Shandong/XTest_NIRS.csv', delimiter=',')
...
best_model_path = r'D:\Postdoc\Paper 12\Datasets\Coal Shandong\Models\SA_NIRS_model.pth'
train_losses = []
val_losses = []
best_epoch = 0
...
csv_path = r'D:\Postdoc\Paper 12\Datasets\Coal Shandong\Models\training_log_SA_NIRS.csv'
...
file_path = r"D:\Postdoc\Paper 12\Datasets\Coal Shandong\Prediction\SA_NIRS_val.csv"
...
file_path = r"D:\Postdoc\Paper 12\Datasets\Coal Shandong\Prediction\SA_NIRS_test.csv"
